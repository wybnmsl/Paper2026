...
# DAG 相关（TSP 下不再走它，但保留兼容）
from eoh.dag.runtime import DagExecutor, REGISTRY
try:
    import eoh.dag.nodes_common as _nodes_common
    import eoh.dag.nodes_tsp as _nodes_tsp
...
class TSPGLS:
        ...
        if tsplib_root is not None:
            try:
                ...
                raise ImportError(
                    ...
                    "Please create zTSP/utils/readTSPLib_runtime.py as designed "
    ...
    def evaluateDAG(self, emitted_code, budgets: dict | None = None):
        ...
        try:
            dag_module.utils = __import__("utils.utils").utils
            dag_module.gls = __import__("gls")
            dag_module.gls.gls_evol = __import__("gls.gls_evol").gls_evol
            dag_module.gls.gls_operators = __import__("gls.gls_operators").gls_operators
        except Exception:
            pass
